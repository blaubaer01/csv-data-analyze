...
def main():
    ...
    print('\U0001f987'*46)
    print('#                                                                                          #')
    print('#               CSV Data Analyze-Tool V4.0 (bat \U0001f987) by Ricky Helfgen                       #')
    ...
    print('#                                                                                          #')
    print('#_|__________###____ _____|____###___####___#___#___###_____####___#####__#__#_____##______#')
    print('#_|________#######________|___#______#______#___#___#__#____#__#_____#____#__#____#__#_____#')
    ...
    print('#_|_#####################_|____###___####_____#_____###_____#__#_____#_______#_##__##______#')
    print('#                                                                                          #')
    print('\U0001f987'*46)
    print('')
